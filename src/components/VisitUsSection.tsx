...
export default function VisitUsSection() {
  ...
  return (
    <div
      className="relative w-full min-h-screen bg-cover bg-center flex items-center justify-center py-12 px-4 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative w-full max-w-2xl z-10 flex flex-col items-center justify-center">
        ...
        <div className="w-full flex flex-col">
          ...
          {/* Card Container */}
          <div
            className="relative w-full rounded-[40px] bg-white/10 backdrop-blur-md p-8 shadow-2xl border border-white/20"
            style={{
              minHeight: "420px",
              boxShadow:
          ...
          >
            ...
            <div className="flex flex-col h-full justify-between">
              ...
              <div className="text-center mb-6">
                <p className="text-white/50 text-sm tracking-widest">BRANCH</p>
                <h2
                  className="text-4xl text-white mt-4 mb-6"
                  style={{
                    fontFamily: "'Great Vibes', cursive",
                    letterSpacing: "0.02em",
                  }}
              ...
              <div className="mt-12">
                ...
                <div className="flex justify-center mb-8">
                  <button
                    className="px-6 py-2 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors border border-white/30 flex items-center gap-2 backdrop-blur"
                    style={{
                      fontFamily: "'Great Vibes', cursive",
                      fontSize: "16px",
